...
void testDeconvForward(HipHandle& handle,
    ...
    CHECK_CALL_MIOPEN(miopenFindConvolutionForwardAlgorithm(
            handle.miopenHandle(),
            xDesc, xData.data(), wDesc, wData.data(),
            deconvDesc, yDesc, yData.data(),
    ...
    if (-1 != bSpec[0]) {
        ...
        CHECK_CALL_MIOPEN(miopenSet4dTensorDescriptor(bDesc,
                miopenFloat, 1, bSpec[0], 1, 1));
        CHECK_CALL_MIOPEN(miopenConvolutionForwardBias(
                handle.miopenHandle(),
                &alpha, bDesc, bData.data(),
                &beta, yDesc, yData.data()));
        CHECK_CALL_MIOPEN(miopenDestroyTensorDescriptor(bDesc));
    }

    CHECK_CALL_MIOPEN(miopenDestroyConvolutionDescriptor(deconvDesc));
...
void testDeconvBackward(HipHandle& handle,
    ...
    CHECK_CALL_MIOPEN(miopenConvolutionBackwardDataGetWorkSpaceSize(
            handle.miopenHandle(),
            dyDesc, wDesc, deconvDesc, dxDesc,
            &workSpaceSize));
    ...
    testSame(dxData, dx, std::string("Backward delta_input-dxData"));
}
...
int main(int argc, char** argv) {
    ...
    std::vector<float> b_array = {-0.0273,  0.2439};
    std::vector<int> b_array_shape = {2}; 
    
    std::vector<float> y_std_bias = {-0.1361,  0.5913,  0.5069, -0.6928,
        0.6383, -0.6554, -0.2334, -0.6669,
        -0.4618, -0.6592, -0.2418, -0.4360,
        0.0694, -0.3109, -0.9228, -0.8446,
        0.2841,  0.6598, -1.0791,  1.4319,
        -1.4997,  0.5645,  0.9509,  0.7201,
        0.7633,  2.2454,  0.6512,  0.2958,
        -0.2502,  0.8582,  1.5164,  1.0074,
        0.8532,  0.8527,  0.2826, -0.6276,
        0.7672, -0.4612, -0.2247,  0.1107,
        -0.3491, -0.1732,  0.3763, -0.0216,
        0.2566,  0.2503,  0.2830, -0.2712,
        -0.5808, -0.0232,  0.9816,  1.5708,
        -0.6327, -0.4542,  0.7449,  0.3728,
        1.1696,  1.3015,  0.0022,  0.8151,
        0.1654, -0.6552, -0.0451,  0.5235};
    std::vector<int> y_std_bias_shape = {2, 2, 4, 4};
    ...
    std::vector<float> y_std_stride = {
        -0.1361, -0.0273,  0.5913, -0.0273,  0.5069, -0.0273, -0.6928,
        -0.0273, -0.0273, -0.0273, -0.0273, -0.0273, -0.0273, -0.0273,
        0.6383, -0.0273, -0.6554, -0.0273, -0.2334, -0.0273, -0.6669,
        -0.0273, -0.0273, -0.0273, -0.0273, -0.0273, -0.0273, -0.0273,
        -0.4618, -0.0273, -0.6592, -0.0273, -0.2418, -0.0273, -0.4360,
        -0.0273, -0.0273, -0.0273, -0.0273, -0.0273, -0.0273, -0.0273,
        0.0694, -0.0273, -0.3109, -0.0273, -0.9228, -0.0273, -0.8446,
        0.2841,  0.2439,  0.6598,  0.2439, -1.0791,  0.2439,  1.4319,
        0.2439,  0.2439,  0.2439,  0.2439,  0.2439,  0.2439,  0.2439,
        -1.4997,  0.2439,  0.5645,  0.2439,  0.9509,  0.2439,  0.7201,
        0.2439,  0.2439,  0.2439,  0.2439,  0.2439,  0.2439,  0.2439,
        0.7633,  0.2439,  2.2454,  0.2439,  0.6512,  0.2439,  0.2958,
        0.2439,  0.2439,  0.2439,  0.2439,  0.2439,  0.2439,  0.2439,
        -0.2502,  0.2439,  0.8582,  0.2439,  1.5164,  0.2439,  1.0074,
        0.8532, -0.0273,  0.8527, -0.0273,  0.2826, -0.0273, -0.6276,
        -0.0273, -0.0273, -0.0273, -0.0273, -0.0273, -0.0273, -0.0273,
        0.7672, -0.0273, -0.4612, -0.0273, -0.2247, -0.0273,  0.1107,
        -0.0273, -0.0273, -0.0273, -0.0273, -0.0273, -0.0273, -0.0273,
        -0.3491, -0.0273, -0.1732, -0.0273,  0.3763, -0.0273, -0.0216,
        -0.0273, -0.0273, -0.0273, -0.0273, -0.0273, -0.0273, -0.0273,
        0.2566, -0.0273,  0.2503, -0.0273,  0.2830, -0.0273, -0.2712,
        -0.5808,  0.2439, -0.0232,  0.2439,  0.9816,  0.2439,  1.5708,
        0.2439,  0.2439,  0.2439,  0.2439,  0.2439,  0.2439,  0.2439,
        -0.6327,  0.2439, -0.4542,  0.2439,  0.7449,  0.2439,  0.3728,
        0.2439,  0.2439,  0.2439,  0.2439,  0.2439,  0.2439,  0.2439,
        1.1696,  0.2439,  1.3015,  0.2439,  0.0022,  0.2439,  0.8151,
        0.2439,  0.2439,  0.2439,  0.2439,  0.2439,  0.2439,  0.2439,
        0.1654,  0.2439, -0.6552,  0.2439, -0.0451,  0.2439,  0.5235};
    std::vector<int> y_std_stride_shape = {2, 2, 7, 7};
    
    std::vector<float> y_std_pad = {-0.6554, -0.2334, -0.6592, -0.2418,
        0.5645,  0.9509, 2.2454,  0.6512,
        -0.4612, -0.2247, -0.1732,  0.3763,
        -0.4542,  0.7449, 1.3015,  0.0022};
    std::vector<int> y_std_pad_shape = {2, 2, 2, 2};
    ...
    DeconvDescriptor deconvDescStride(0, 0, 2, 2, 1, 1);
    DeconvDescriptor deconvDescPadding(1, 1, 1, 1, 1, 1);
    
    HipHandle handle(0);
    
    testDeconvForward(handle, deconvDescTrivial, 
            x_array, x_array_shape,
            w_array, w_array_shape,
            b_array, b_array_shape,
            y_std_bias, y_std_bias_shape);

    testDeconvForward(handle, deconvDescStride, 
            x_array, x_array_shape,
            w_array, w_array_shape,
            b_array, b_array_shape,
            y_std_stride, y_std_stride_shape);
    
    testDeconvForward(handle, deconvDescPadding, 
            x_array, x_array_shape,
            w_array, w_array_shape,
            b_array, b_array_shape,
            y_std_pad, y_std_pad_shape);
